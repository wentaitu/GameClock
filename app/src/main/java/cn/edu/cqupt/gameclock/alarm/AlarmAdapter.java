...
import cn.edu.cqupt.gameclock.activity.AlarmSettingsActivity;
...
public class AlarmAdapter extends RecyclerView.Adapter<AlarmAdapter.ContentViewHolder> {
    ...
    public class ContentViewHolder extends RecyclerView.ViewHolder
        ...
        public void openAlarmSettings(Context context) {
            ...
            final Intent intent = new Intent(context, AlarmSettingsActivity.class);
            intent.putExtra(AlarmSettingsActivity.EXTRAS_ALARM_ID, info.getAlarmId());
            ...
            builder.setItems(actions, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    if (actions[which].equals(actions[0])) {
                        ...
                        DialogFragment delete = new AlarmClockActivity.ActivityDialogFragment().newInstance(
                                AlarmClockActivity.DELETE_ALARM_CONFIRM, info,
                                getAdapterPosition());
